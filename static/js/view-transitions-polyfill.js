  ...
  setup(t, n) {
    this.element = t,
      ...
      this.element instanceof HTMLVideoElement
        ? (this.clone.width = this.element.videoWidth, this.clone.height = this.element.videoHeight)
        : this.element instanceof HTMLCanvasElement &&
          (this.clone.width = this.element.width, this.clone.height = this.element.height);
  }
  connectedCallback() {
...
function _t(e, t) {
  ...
  if (
    (n === 43 || n === 45) && (n = e.charCodeAt(t += 1)),
      V(n) && (t = Ht(e, t + 1), n = e.charCodeAt(t)),
      n === 46 && V(e.charCodeAt(t + 1)) && (t += 2, t = Ht(e, t)),
      Me(
        e,
        t,
        101,
...
function rr(e) {
  const t = e.source,
    n = t.length,
    r = t.length > 0 ? pi(t.charCodeAt(0)) : 0,
    i = vt(e.lines, n),
    o = vt(e.columns, n);
  ...
  for (let c = r; c < n; c++) {
    ...
    i[c] = s,
      o[c] = l++,
      (a === tr || a === nr || a === ds) &&
      (a === nr && c + 1 < n && t.charCodeAt(c + 1) === tr &&
        (c++, i[c] = s, o[c] = l),
        s++,
        l = 1);
  }
...
class gs {
  ...
  setSource(t = '', n = () => {
    ...
    t = String(t || '');
    const r = t.length,
      i = vt(this.offsetAndType, t.length + 1),
      o = vt(this.balance, t.length + 1);
    let s = 0, l = 0, c = 0, a = -1;
    for (
  ...
  getTokenStart(t) {
    return t === this.tokenIndex
      ? this.tokenStart
      : t > 0
      ? t < this.tokenCount ? this.offsetAndType[t - 1] & ne : this.offsetAndType[this.tokenCount] & ne
  ...
  isDelim(t, n) {
    return n
      ...
      : this.tokenType === A && this.source.charCodeAt(this.tokenStart) === t;
  }
  skip(t) {
    let n = this.tokenIndex + t;
    n < this.tokenCount
      ? (this.tokenIndex = n,
        this.tokenStart = this.offsetAndType[n - 1] & ne,
  ...
  skipUntilBalanced(t, n) {
    ...
    for (; r < this.tokenCount; r++) {
      ...
      switch (
        o = r > 0 ? this.offsetAndType[r - 1] & ne : this.firstCharOffset, n(this.source.charCodeAt(o))
      ) {
        case 1:
          break e;
        case 2:
    ...
    return t.head === null
      ...
      : (n != null
        ? (this.updateCursors(n.prev, t.tail, n, t.head),
          n.prev !== null ? (n.prev.next = t.head, t.head.prev = n.prev) : this.head = t.head,
          n.prev = t.tail,
          t.tail.next = n)
...
`.repeat(Math.max(r - 1, 0)),
    c = ' '.repeat(Math.max(i - 1, 0)),
    a = (l + c + e).split(/\r\n?|\n|\f/),
    u = Math.max(1, t - o) - 1,
    p = Math.min(t + o, a.length + 1),
    d = Math.max(4, String(p).length) + 1;
  let g = 0;
  n += (or.length - 1) * (a[t - 1].substr(0, n - 1).match(/\t/g) || []).length, n > qt && (g = n - ir + 3, n = ir - 2);
  for (let w = u; w <= p; w++) {
    w >= 0 && w < a.length &&
      (a[w] = a[w].replace(/\t/g, or),
        a[w] = (g > 0 && a[w].length > g ? '…' : '') + a[w].substr(g, qt - 2) +
          (a[w].length > g + qt - 1 ? '…' : ''));
  }
  return [
    s(u, t),
...
function vs(e) {
  ...
  const s = new ms(),
    l = Object.assign(new gs(), xs(e || {}), {
      ...
      lookupNonWSType(a) {
        let u;
        do if (u = this.lookupType(a++), u !== N && u !== q) {
          return u;
        } while (u !== ur);
        return ur;
      },
      ...
      eat(a) {
        if (this.tokenType !== a) {
          ...
          let p = `${/[[\](){}]/.test(u) ? `"${u}"` : u} is expected`,
            d = this.tokenStart;
          switch (a) {
            case b:
              this.tokenType === S || this.tokenType === U
                ? (d = this.tokenEnd - 1, p = 'Identifier is expected but function found')
            ...
            case M:
              this.tokenType === v &&
                (d = this.tokenEnd, p = 'Percent sign is expected');
              break;
          }
          this.error(p, d);
        }
      ...
      eatIdent(a) {
        (this.tokenType !== b || this.lookupValue(0, a) === !1) &&
        this.error(`Identifier "${a}" is expected`), this.next();
      },
      eatDelim(a) {
        this.isDelim(a) ||
        this.error(`Delim "${String.fromCharCode(a)}" is expected`), this.next();
      },
      getLocation(a, u) {
        return r
          ? s.getLocationRange(
      ...
      error(a, u) {
        const p = typeof u < 'u' && u < t.length
          ? s.getLocation(u)
          : this.eof
          ? s.getLocation(hs(t, t.length - 1))
  ...
  return Object.assign(function (a, u) {
    t = a,
      ...
      n = u.filename || '<unknown>',
      r = !!u.positions,
      i = typeof u.onParseError == 'function' ? u.onParseError : lr,
      o = !1,
      l.parseAtrulePrelude = 'parseAtrulePrelude' in u ? !!u.parseAtrulePrelude : !0,
      l.parseRulePrelude = 'parseRulePrelude' in u ? !!u.parseRulePrelude : !0,
      l.parseValue = 'parseValue' in u ? !!u.parseValue : !0,
      l.parseCustomProperty = 'parseCustomProperty' in u ? !!u.parseCustomProperty : !1;
    ...
    typeof d == 'function' && l.forEachToken((w, z, L) => {
      if (w === q) {
        const y = l.getLocation(z, L),
          C = Ze(t, L - 2, L, '*/') ? t.slice(z + 2, L - 2) : t.slice(z + 2, L);
        d(C, y);
      }
    });
...
var Pn = {},
  _n = {},
  hr = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/'.split(
    '',
  );
...
Pn.encode = function (t) {
  var n = '', r, i = Ss(t);
  do r = i & ki, i >>>= In, i > 0 && (r |= wi), n += bi.encode(r); while (
    i > 0
  );
  return n;
};
...
(function (e) {
    ...
    for (var it, Re = 0, Q = ae.length - 1; Q >= 0; Q--) {
      it = ae[Q],
        it === '.'
          ...
          : it === '..'
          ? Re++
          : Re > 0 && (it === '' ? (ae.splice(Q + 1, Re), Re = 0) : (ae.splice(Q, 2), Re--));
    }
  ...
  function z(h) {
    ...
    var m = h.length;
    if (
      m < 9 || h.charCodeAt(m - 1) !== 95 || h.charCodeAt(m - 2) !== 95 ||
      h.charCodeAt(m - 3) !== 111 || h.charCodeAt(m - 4) !== 116 ||
      h.charCodeAt(m - 5) !== 111 || h.charCodeAt(m - 6) !== 114 ||
      h.charCodeAt(m - 7) !== 112 || h.charCodeAt(m - 8) !== 95 ||
      h.charCodeAt(m - 9) !== 95
    ) {
      return !1;
    }
  ...
  function L(h, m, k) {
    ...
    return f !== 0 || (f = h.originalLine - m.originalLine, f !== 0) ||
        (f = h.originalColumn - m.originalColumn, f !== 0 || k) ||
        (f = h.generatedColumn - m.generatedColumn, f !== 0) ||
        (f = h.generatedLine - m.generatedLine, f !== 0)
      ? f
      : E(h.name, m.name);
  }
  ...
  function y(h, m, k) {
    var f;
    return f = h.originalLine - m.originalLine,
      f !== 0 || (f = h.originalColumn - m.originalColumn, f !== 0 || k) ||
        (f = h.generatedColumn - m.generatedColumn, f !== 0) ||
        (f = h.generatedLine - m.generatedLine, f !== 0)
        ? f
        : E(h.name, m.name);
  ...
  function C(h, m, k) {
    ...
    return f !== 0 ||
        (f = h.generatedColumn - m.generatedColumn, f !== 0 || k) ||
        (f = E(h.source, m.source), f !== 0) ||
        (f = h.originalLine - m.originalLine, f !== 0) ||
        (f = h.originalColumn - m.originalColumn, f !== 0)
      ? f
      : E(h.name, m.name);
  }
  ...
  function D(h, m, k) {
    ...
    return f !== 0 || k || (f = E(h.source, m.source), f !== 0) ||
        (f = h.originalLine - m.originalLine, f !== 0) ||
        (f = h.originalColumn - m.originalColumn, f !== 0)
      ? f
      : E(h.name, m.name);
  ...
  function Z(h, m) {
    ...
    return k !== 0 || (k = h.generatedColumn - m.generatedColumn, k !== 0) ||
        (k = E(h.source, m.source), k !== 0) ||
        (k = h.originalLine - m.originalLine, k !== 0) ||
        (k = h.originalColumn - m.originalColumn, k !== 0)
      ? k
      : E(h.name, m.name);
  }
  ...
  function R(h, m, k) {
    if (
      m = m || '', h && (h[h.length - 1] !== '/' && m[0] !== '/' && (h += '/'), m = h + m), k
    ) {
      var f = i(k);
      if (!f) {
...
ye.prototype.add = function (t, n) {
  var r = Te ? t : zn.toSetString(t),
    i = Te ? this.has(t) : Mn.call(this._set, r),
...
function Es(e, t) {
  var n = e.generatedLine,
    ...
    o = t.generatedColumn;
  return r > n || r == n && o >= i ||
    Si.compareByGeneratedPositionsInflated(e, t) <= 0;
}
function Nt() {
...
Nt.prototype.toArray = function () {
  return this._sorted ||
    (this._array.sort(Si.compareByGeneratedPositionsInflated), this._sorted = !0),
    this._array;
};
vi.MappingList = Nt;
...
function oe(e) {
  e || (e = {}),
    ...
    this._ignoreInvalidMapping = j.getArg(e, 'ignoreInvalidMapping', !1),
    this._sources = new St(),
    this._names = new St(),
    this._mappings = new Ts(),
    this._sourcesContents = null;
}
oe.prototype._version = 3;
oe.fromSourceMap = function (t, n) {
  var r = t.sourceRoot,
    i = new oe(Object.assign(n || {}, {
      file: t.file,
      sourceRoot: r,
    }));
  return t.eachMapping(function (o) {
    ...
    o.source != null &&
    (s.source = o.source,
      r != null && (s.source = j.relative(r, s.source)),
      s.original = {
        line: o.originalLine,
...
oe.prototype.addMapping = function (t) {
  var n = j.getArg(t, 'generated'),
    r = j.getArg(t, 'original', null),
    i = j.getArg(t, 'source', null),
    o = j.getArg(t, 'name', null);
  !this._skipValidation && this._validateMapping(n, r, i, o) === !1 ||
...
oe.prototype.setSourceContent = function (t, n) {
  var r = t;
  this._sourceRoot != null && (r = j.relative(this._sourceRoot, r)),
    n != null
      ? (this._sourcesContents ||
        (this._sourcesContents = /* @__PURE__ */ Object.create(null)),
        this._sourcesContents[j.toSetString(r)] = n)
      : this._sourcesContents &&
...
oe.prototype.applySourceMap = function (t, n, r) {
  ...
  this._mappings.unsortedForEach(function (c) {
    if (c.source === i && c.originalLine != null) {
      ...
      a.source != null &&
        (c.source = a.source,
          r != null && (c.source = j.join(r, c.source)),
          o != null && (c.source = j.relative(o, c.source)),
    ...
    t.sources.forEach(function (c) {
      ...
      a != null &&
        (r != null && (c = j.join(r, c)), o != null && (c = j.relative(o, c)), this.setSourceContent(c, a));
    }, this);
};
oe.prototype._validateMapping = function (t, n, r, i) {
  ...
  if (
    !(t && 'line' in t && 'column' in t && t.line > 0 && t.column >= 0 && !n &&
      !r && !i)
  ) {
    if (
      t && 'line' in t && 'column' in t && n && 'line' in n && 'column' in n &&
      t.line > 0 && t.column >= 0 && n.line > 0 && n.column >= 0 && r
    ) {
      return;
    }
...
oe.prototype._serializeMappings = function () {
  for (
    ...
    c += Be.encode(a.generatedColumn - t),
      t = a.generatedColumn,
      a.source != null &&
      (p = this._sources.indexOf(a.source),
        c += Be.encode(p - s),
        s = p,
        c += Be.encode(a.originalLine - 1 - i),
        i = a.originalLine - 1,
        c += Be.encode(a.originalColumn - r),
        r = a.originalColumn,
        a.name != null &&
        (u = this._names.indexOf(a.name), c += Be.encode(u - o), o = u)),
      l += c;
  }
  return l;
};
...
oe.prototype.toJSON = function () {
  ...
  return this._file != null && (t.file = this._file),
    ...
    if (d.loc && d.loc.start && pr.has(d.type)) {
      ...
      (r.line !== g || r.column !== w) &&
        (r.line = g,
          ...
          n.column = l,
          c &&
          (c = !1, (n.line !== i.line || n.column !== i.column) && t.addMapping(o)),
          c = !0,
          t.addMapping({
            source: d.loc.source,
            original: r,
...
function Ei(e) {
  ...
  return function (n, r, i) {
    ...
    return (s === Ls && r !== b && r !== S && r !== X || s === Os ? t.has(n << 16 | s << 8) : t.has(n << 16 | o)) &&
      this.emit(' ', N, !0),
      o;
  };
}
  ...
  return function (n, r) {
    let i = '',
      ...
      s = {
        ...
        tokenBefore: Ti,
        token(c, a) {
          o = this.tokenBefore(o, c, a),
            this.emit(a, c, !1),
            c === A && a.charCodeAt(0) === Is && this.emit(
              `
`,
              N,
              !0,
    ...
    r &&
      (typeof r.decorator == 'function' && (s = r.decorator(s)),
        r.sourceMap && (s = $s(s)),
        r.mode in dr && (s.tokenBefore = dr[r.mode]));
    const l = {
      node: (c) => s.node(c),
      children: zs,
...
function js(e) {
  return {
    fromPlainObject(t) {
      return e(t, {
        enter(n) {
          n.children && !(n.children instanceof B) &&
            (n.children = new B().fromArray(n.children));
        },
      }),
        t;
    },
...
function gr(e, t) {
  ...
  return t && n.reverse(), function (o, s, l, c) {
    let a;
    i && (a = s[r], s[r] = o);
    for (const u of n) {
      const p = o[u.name];
      if (!u.nullable || p) {
        if (u.type === 'list') {
          if (t ? p.reduceRight(c, !1) : p.reduce(c, !1)) {
            return !0;
          }
        } else if (l(p)) {
          return !0;
...
function Rs(e) {
  const t = Ds(e),
    ...
    o = Symbol('skip-node');
  for (const a in t) {
    Nn.call(t, a) && t[a] !== null &&
      (n[a] = gr(t[a], !1), r[a] = gr(t[a], !0));
  }
  const s = br(n),
    l = br(r),
    c = function (a, u) {
      function p(y, C, D) {
        const E = d.call(L, y, C, D);
        return E === i ? !0 : E === o ? !1 : !!(w.hasOwnProperty(y.type) && w[y.type](y, L, p, z) ||
          g.call(L, y, C, D) === i);
      }
      let d = Ve, g = Ve, w = n, z = (y, C, D, E) => y || p(C, D, E);
      const L = {
        break: i,
        skip: o,
        root: a,
      ...
      if (typeof u == 'function') {
        ...
        u && (d = mr(u.enter), g = mr(u.leave), u.reverse && (w = r), u.visit)
      ) {
        if (s.hasOwnProperty(u.visit)) {
          w = u.reverse ? l[u.visit] : s[u.visit];
        } else if (!t.hasOwnProperty(u.visit)) {
          throw new Error(
            'Bad value `' + u.visit + '` for `visit` option (should be: ' +
              Object.keys(t).sort().join(', ') + ')',
          );
        }
        d = fr(d, u.visit), g = fr(g, u.visit);
      }
      if (d === Ve && g === Ve) {
        throw new Error(
  ...
  return c.break = i,
    ...
    c.find = function (a, u) {
      let p = null;
      return c(a, function (d, g, w) {
        if (u.call(this, d, g, w)) {
          return p = d, i;
        }
      }),
        p;
    ...
    c.findAll = function (a, u) {
      const p = [];
      return c(a, function (d, g, w) {
        u.call(this, d, g, w) && p.push(d);
      }),
        p;
    },
    c;
...
function qs(e, t, n, r) {
  const i = e.combinator === ' ' || r ? e.combinator : ' ' + e.combinator + ' ',
    o = e.terms.map((s) => jn(s, t, n, r)).join(i);
...
function Fn(e, t) {
  ...
  return typeof t == 'function' ? n = t : t &&
    (r = !!t.forceBraces, i = !!t.compact, typeof t.decorate == 'function' && (n = t.decorate)),
    jn(e, n, r, i);
}
...
function Ws(e, t) {
  const n = e.tokens,
    ...
    o = i !== t ? i : null;
  let s = 0, l = 0, c = 0, a = '', u, p;
  for (let d = 0; d < n.length; d++) {
    const g = n[d].value;
    d === r && (l = g.length, s = a.length), o !== null && n[d].node === o && (d <= r ? c++ : c = 0), a += g;
  }
  return r === n.length || c > 1
    ? (u = at(o || t, 'end') || qe(yr, a), p = qe(u))
    : (u = at(o, 'start') || qe(at(t, 'start') || yr, a.slice(0, s)), p = at(o, 'end') || qe(u, a.substr(s, l))),
    {
      css: a,
      mismatchOffset: s,
      mismatchLength: l,
...
function Ai(e, t) {
  if (
    t = t || 0, e.length - t >= 3 && e.charCodeAt(t) === Ct && e.charCodeAt(t + 1) !== Ct
  ) {
...
function Ks(e) {
  ...
  const i = r ? '' : Ai(t, n.length),
    o = t.substr(0, n.length + i.length),
    s = Object.freeze({
...
function Ys(e, t) {
  ...
  if (e.type === b && e.value.charCodeAt(0) === de) {
    ...
    return o === i || !Me(e.value, o, Qt)
      ? 0
      : o + 1 === e.value.length
      ? Yt(t(++n), n, t)
      : e.value.charCodeAt(o + 1) !== de
      ? 0
      : o + 2 === e.value.length
      ? (n = Ke(t(++n), n, t), e = t(n), we(e, 0, Pe, n))
      : we(e, o + 2, Pe, n);
  }
  return 0;
}
...
function ea(e, t) {
  let n = 0;
  if (
    e === null || e.type !== b || !Me(e.value, 0, Js) ||
    (e = t(++n), e === null)
  ) {
    return 0;
  }
  ...
  if (e.type === v) {
    ...
    return r === 0
      ? 0
      : (e = t(++n),
        e === null ? n : e.type === T || e.type === v ? !Zs(e, $i) || !We(e, 1, !1) ? 0 : n + 1 : ct(r, n, t));
  }
  return e.type === T ? ct(We(e, 1, !0), ++n, t) : 0;
}
const ta = ['calc(', '-moz-calc(', '-webkit-calc('],
  Bn = /* @__PURE__ */ new Map([
    [S, x],
    [$, x],
    [te, ue],
...
function jt(e, t, n) {
  if (e && e.type === 'Range') {
    ...
    if (
      isNaN(r) || e.min !== null && r < e.min && typeof e.min != 'string' ||
      e.max !== null && r > e.max && typeof e.max != 'string'
    ) {
      return !0;
    }
  }
...
function re(e) {
  return function (t, n, r) {
    return t === null ? 0 : t.type === S && Pi(t.value, ta) ? na(t, n) : e(t, n, r);
  };
}
function _(e) {
  return function (t) {
...
function Ii(e) {
  return e === null || e.type !== b || ce(e.value, 0) !== 45 ||
      ce(e.value, 1) !== 45
    ? 0
    : 1;
}
...
function sa(e) {
  return e === null || e.type !== I ||
      !mt(ce(e.value, 1), ce(e.value, 2), ce(e.value, 3))
    ? 0
    : 1;
}
function aa(e, t) {
...
function be(e) {
  return e && (e = new Set(e)), function (t, n, r) {
    ...
    if (e !== null) {
      const o = t.value.indexOf('\\', i),
        s = o === -1 || !_i(t.value, o) ? t.value.substr(i) : t.value.substring(i, o);
...
function ca(e, t, n) {
  return e === null || e.type !== M || jt(n, e.value, e.value.length - 1) ? 0 : 1;
}
function zi(e) {
...
const pa = {
    ...
    'delim-token': _(A),
    'number-token': _(v),
    'percentage-token': _(M),
    'dimension-token': _(T),
    'whitespace-token': _(N),
    'CDO-token': _(nt),
    'CDC-token': _(X),
    'colon-token': _(G),
    'semicolon-token': _(K),
...
class La {
  ...
  eat(t) {
    this.charCode() !== t &&
    this.error('Expect `' + String.fromCharCode(t) + '`'), this.pos++;
  }
  peek() {
...
function Ar(e) {
  ...
  return e.eat(Tt),
    ...
    t = $t(e),
    e.skipWs(),
    e.charCode() === qn ? (e.pos++, e.skipWs(), e.charCode() !== Cr && (n = $t(e), e.skipWs())) : n = t,
    e.eat(Cr),
    {
      min: Number(t),
      max: n ? Number(n) : 0,
...
function Da(e) {
  ...
  switch (e.charCode()) {
    ...
    case Hn:
      e.pos++,
        n = !0,
        e.charCode() === Tt ? t = Ar(e) : e.charCode() === mn
          ? (e.pos++,
            t = {
              min: 0,
              max: 0,
...
function Ba(e) {
  ...
  return e.eat(Ft),
    e.charCode() === vr && (e.peek(), r = -1),
    r == -1 && e.charCode() === Er ? e.peek() : (t = r * Number($t(e)), tt[e.charCode()] !== 0 && (t += je(e))),
    At(e),
    e.eat(qn),
    At(e),
    e.charCode() === Er
...
function Ha(e) {
  ...
  return e.eat(Wn),
    t = je(e),
    e.charCode() === Ni && e.nextCharCode() === Na && (e.pos += 2, t += '()'),
    e.charCodeAt(e.findWsEnd(e.pos)) === Ft && (At(e), n = Ba(e)),
    e.eat(Fi),
    Fe(e, {
      type: 'Type',
      name: t,
...
function qa(e, t) {
  ...
  for (t = Object.keys(t).sort((i, o) => Tr[i] - Tr[o]); t.length > 0;) {
    ...
    for (; i < e.length; i++) {
      const s = e[i];
      s.type === 'Combinator' &&
        (s.value === r ? (o === -1 && (o = i - 1), e.splice(i, 1), i--) : (o !== -1 && i - o > 1 && (e.splice(
          o,
          i - o,
          n(e.slice(o, i), r),
        ),
...
function Di(e) {
  ...
  for (; r = Ua(e);) {
    r.type !== 'Spaces' &&
      (r.type === 'Combinator'
        ? ((i === null || i.type === 'Combinator') &&
          (e.pos = o, e.error('Unexpected combinator')),
          n[r.value] = !0)
        : i !== null && i.type !== 'Combinator' && (n[' '] = !0,
          t.push({
            type: 'Combinator',
            value: ' ',
          })),
  ...
  return i !== null && i.type === 'Combinator' &&
    (e.pos -= o, e.error('Unexpected combinator')),
    {
      type: 'Group',
      terms: t,
...
function Ga(e, t, n) {
  ...
  let i = Ue, o = Ue;
  if (
    typeof t == 'function' ? i = t : t && (i = $r(t.enter), o = $r(t.leave)), i === Ue && o === Ue
  ) {
    throw new Error(
      "Neither `enter` nor `leave` walker handler is set or both aren't a function",
    );
...
const O = { type: 'Match' },
  P = { type: 'Mismatch' },
  Gn = { type: 'DisallowEmpty' },
  Xa = 40,
  Ja = 41;
function W(e, t, n) {
  return t === O && n === P || e === O && t === O && n === O
    ? e
    : (e.type === 'If' && e.else === P && t === O && (t = e.then, e = e.match), {
      type: 'If',
      match: e,
      then: t,
      else: n,
...
function Bi(e) {
  return e.length > 2 && e.charCodeAt(e.length - 2) === Xa &&
    e.charCodeAt(e.length - 1) === Ja;
}
function Or(e) {
  return e.type === 'Keyword' || e.type === 'AtKeyword' ||
    e.type === 'Function' || e.type === 'Type' && Bi(e.name);
}
function fn(e, t, n) {
  switch (e) {
    case ' ': {
    ...
    case '|': {
      ...
      for (let o = t.length - 1; o >= 0; o--) {
        ...
        if (
          ...
          const l = (Bi(s.name) ? s.name.slice(0, -1) : s.name).toLowerCase();
          if (!(l in i)) {
            i[l] = s;
            continue;
          }
...
const { hasOwnProperty: Lr } = Object.prototype,
  el = 0,
  tl = 1,
  gn = 2,
  Hi = 3,
  Pr = 'Match',
  nl = 'Mismatch',
  rl = 'Maximum iteration number exceeded (please fill an issue on https://github.com/csstree/csstree/issues)',
  _r = 15e3;
function il(e) {
...
function Ir(e) {
  return e === null ? !0 : e.type === J || e.type === S || e.type === $ || e.type === te ||
    e.type === H || ol(e);
}
function zr(e) {
  return e === null ? !0 : e.type === x || e.type === ue || e.type === ie ||
    e.type === A && e.value === '/';
}
function sl(e, t, n) {
  function r() {
    do C++, y = C < e.length ? e[C] : null; while (
      y !== null && (y.type === N || y.type === q)
    );
  }
  function i(Z) {
    const se = C + Z;
    ...
    switch (t.type) {
      case 'Match':
        if (d === null) {
          if (
            y !== null &&
            (C !== e.length - 1 || y.value !== '\\0' && y.value !== '\\9')
          ) {
            t = P;
            break;
          }
      ...
      case 'MatchGraph':
        ...
        break;
      case 'If':
        t.else !== P && l(t.else), t.then !== O && s(t.then), t = t.match;
        break;
      case 'MatchOnce':
        t = {
      ...
      case 'Enum':
        if (y !== null) {
          let R = y.value.toLowerCase();
          if (
            R.indexOf('\\') !== -1 && (R = R.replace(/\\[09].*$/, '')), Lr.call(t.map, R)
          ) {
            t = t.map[R];
            break;
          }
        ...
        break;
      case 'Generic': {
        const R = p !== null ? p.opts : null, h = C + Math.floor(t.fn(y, i, R));
        if (!isNaN(h) && h > C) {
          for (; C < h;) {
            c();
          }
      ...
      case 'Type':
      case 'Property': {
        const R = t.type === 'Type' ? 'types' : 'properties',
          h = Lr.call(n, R) ? n[R][t.name] : null;
        if (!h || !h.match) {
          throw new Error(
        ...
        if (
          w !== !1 && y !== null && t.type === 'Type' && // https://drafts.csswg.org/css-values-4/#custom-idents
          // When parsing positionally-ambiguous keywords in a property value, a <custom-ident> production
          // can only claim the keyword if no other unfulfilled production can claim it.
          (t.name === 'custom-ident' && y.type === b || // https://drafts.csswg.org/css-values-4/#lengths
            // ... if a `0` could be parsed as either a <number> or a <length> in a property (such as line-height),
            // it must parse as a <number>
            t.name === 'length' && y.value === '0')
        ) {
          w === null && (w = o(t, g)), t = P;
          break;
        }
      ...
      case 'Keyword': {
        ...
        if (y !== null) {
          let h = y.value;
          if (
            h.indexOf('\\') !== -1 && (h = h.replace(/\\[09].*$/, '')), Jt(h, R)
          ) {
            c(), t = O;
            break;
          }
      ...
      case 'Token':
        ...
        break;
      case 'Comma':
        y !== null && y.type === J ? Ir(E.token) ? t = P : (c(), t = zr(y) ? P : O) : t = Ir(E.token) || zr(y) ? O : P;
        break;
      case 'String':
        let Z = '', se = C;
        for (; se < e.length && Z.length < t.value.length; se++) {
          Z += e[se].value;
        }
        if (Jt(Z, t.value)) {
          for (; C < se;) {
  ...
  switch (L) {
    case null:
      console.warn('[csstree-match] BREAK after ' + _r + ' iterations'), L = rl, E = null;
      break;
    case Pr:
      for (; p !== null;) {
        u();
...
function Nr(e, t, n, r, i) {
  function o(l) {
    if (l.syntax !== null && l.syntax.type === r && l.syntax.name === i) {
      const c = qi(l), a = Wi(l);
      e.syntax.walk(t, function (u, p, d) {
        if (u === c) {
          const g = new B();
          do {
    ...
    Array.isArray(l.match) && l.match.forEach(o);
  }
  const s = [];
  ...
  return function (r, i) {
    ...
    for (let o in r) {
      ...
      if (Qe.call(r, o) !== !1) {
        if (o === 'type') {
          r.type !== e &&
            i(r, 'Wrong node type `' + r.type + '`, expected `' + e + '`');
        } else if (o === 'loc') {
          if (r.loc === null) {
            continue;
          }
          ...
          for (let l = 0; !s && l < t[o].length; l++) {
            ...
            switch (c) {
              ...
              case null:
                ...
                break;
              default:
                typeof c == 'string' ? s = r[o] && r[o].type === c : Array.isArray(c) && (s = r[o] instanceof B);
            }
          }
        } else {
    ...
    for (const o in t) {
      Qe.call(t, o) && Qe.call(r, o) === !1 &&
        i(r, 'Field `' + e + '.' + o + '` is missed');
    }
  };
}
function Ui(e, t) {
...
function ml(e, t, n) {
  ...
  for (const [i, o] of Object.entries(e)) {
    r[i] = {
      prelude: o.prelude &&
        (n ? o.prelude.syntax : Fn(o.prelude.syntax, { compact: t })),
...
function gl(e) {
  const t = e.terms[0];
  return e.explicit === !1 && e.terms.length === 1 && t.type === 'Multiplier' &&
    t.comma === !0;
}
function le(e, t, n) {
  return {
...
function _e(e, t, n, r) {
  ...
  let o;
  return fl(i)
    ? le(null, new Error('Matching for a tree with var() is not supported'))
    : (r && (o = Mr(i, e.cssWideKeywordsSyntax, e)),
      (!r || !o.match) && (o = Mr(i, t.match, e), !o.match)
        ? le(
          null,
...
class Fr {
  constructor(t, n, r) {
    if (
      this.cssWideKeywords = Rn,
        ...
        this.structure = r || dl(t),
        t
    ) {
      if (
        t.cssWideKeywords && (this.cssWideKeywords = t.cssWideKeywords), t.units
      ) {
  ...
  createDescriptor(t, n, r, i = null) {
    ...
    return typeof t == 'function' ? s.match = ut(t, o) : (typeof t == 'string'
  ...
  matchDeclaration(t) {
    return t.type !== 'Declaration'
      ? le(null, new Error('Not a Declaration node'))
  ...
  getAtruleDescriptor(t, n) {
    return this.atrules.hasOwnProperty(t) && this.atrules.declarators &&
        this.atrules[t].declarators[n] || null;
  }
  getProperty(t, n = !0) {
    const r = kr(t);
  ...
  validate() {
    ...
    function n(c, a, u, p) {
      ...
      u.set(a, !1),
        p.syntax !== null && Ga(p.syntax, function (d) {
          if (d.type !== 'Type' && d.type !== 'Property') {
            return;
          }
          const g = d.type === 'Type' ? c.types : c.properties,
            w = d.type === 'Type' ? i : o;
          hasOwnProperty.call(g, d.name)
            ? n(c, d.name, w, g[d.name]) &&
              (r.push(
                `${t(a, u === i)} used broken syntax definition ${t(d.name, d.type === 'Type')}`,
              ),
                u.set(a, !0))
            : (r.push(
              `${t(a, u === i)} used missed syntax definition ${t(d.name, d.type === 'Type')}`,
            ),
              u.set(a, !0));
        }, this);
    }
    ...
    for (const c in this.types) {
      n(this, c, i, this.types[c]);
    }
    for (const c in this.properties) {
      n(this, c, o, this.properties[c]);
    }
    const s = [...i.keys()].filter((c) => i.get(c)),
      l = [...o.keys()].filter((c) => o.get(c));
...
function en(e, t) {
  return typeof t == 'string' && /^\s*\|/.test(t)
    ? typeof e == 'string' ? e + t : t.replace(/^\s*\|\s*/, '')
    : t || null;
}
function Dr(e, t) {
    ...
    switch (r) {
      ...
      case 'atrules':
        ...
        for (const [o, s] of Object.entries(i)) {
          const l = n[r][o] || {},
            c = n[r][o] = {
              prelude: l.prelude || null,
              descriptors: {
                ...l.descriptors,
              },
            };
          if (s) {
            c.prelude = s.prelude ? en(c.prelude, s.prelude) : c.prelude || null;
            for (const [a, u] of Object.entries(s.descriptors || {})) {
              c.descriptors[a] = u ? en(c.descriptors[a], u) : null;
            }
...
function Gi(e) {
  const t = vs(e),
    n = Rs(e),
    r = Ns(e),
    { fromPlainObject: i, toPlainObject: o } = js(n),
    s = {
      lexer: null,
      createLexer: (l) => new Fr(l, s, s.lexer.structure),
      tokenize: It,
      parse: t,
      generate: r,
      walk: n,
...
const bl = (e) => Gi(yn({}, e)),
  yl = {
    ...
    properties: {
      ...
      font:
        "[[<'font-style'>||<font-variant-css2>||<'font-weight'>||<font-width-css3>]? <'font-size'> [/ <'line-height'>]? <'font-family'>#]|<system-family-name>|<-non-standard-font>",
...
function tn() {
  ...
  if (n !== v) {
    if (this.isDelim(me, e) || this.isDelim(ee, e)) {
      ...
      do n = this.lookupType(++e); while (n === N || n === q);
  ...
  return e > 0 && this.skip(e),
    t === 0 &&
    (n = this.charCodeAt(this.tokenStart), n !== me && n !== ee && this.error('Number sign is expected')),
    Ie.call(this, t !== 0),
    t === ee ? '-' + this.consume(v) : this.consume(v);
}
const wl = 'AnPlusB',
  xl = {
    a: [String, null],
...
function Ki() {
  ...
  if (this.tokenType === v) {
    ...
    this.tokenType === b || this.isDelim(me) && this.lookupType(1) === b
  ) {
    let r = 0;
    switch (
      t = '1', this.isDelim(me) && (r = 1, this.next()), ke.call(this, 0, gt), this.tokenEnd - this.tokenStart
    ) {
      case 1:
        this.next(), n = tn.call(this);
        break;
    ...
    this.error('Integer is expected', this.tokenStart + i),
      ke.call(this, o - this.tokenStart, gt),
      t = this.substring(e, o),
      o + 1 === this.tokenEnd
        ? (this.next(), n = tn.call(this))
        : (ke.call(this, o - this.tokenStart + 1, ee),
          o + 2 === this.tokenEnd
            ? (this.next(), this.skipSC(), Ie.call(this, Ce), n = '-' + this.consume(v))
            : (bt.call(this, o - this.tokenStart + 2, Ce), this.next(), n = this.substrToCursor(o + 1)));
  } else {
    this.error();
  }
  return t !== null && t.charCodeAt(0) === me && (t = t.substr(1)),
    n !== null && n.charCodeAt(0) === me && (n = n.substr(1)),
    {
      type: 'AnPlusB',
...
function Qi(e = !1) {
  ...
  switch (
    this.eat(F),
      ...
      r = n.toLowerCase(),
      this.skipSC(),
      this.eof === !1 && this.tokenType !== H && this.tokenType !== K &&
      (this.parseAtrulePrelude
        ? i = this.parseWithFallback(this.AtrulePrelude.bind(this, n, e), Rr)
        : i = Rr.call(this, this.tokenIndex),
        this.skipSC()),
      this.tokenType
  ) {
    case K:
    ...
    case H:
      hasOwnProperty.call(this.atrule, r) &&
        ...
        ? o = this.atrule[r].block.call(this, e)
        : o = this.Block(Cl.call(this));
      break;
  }
  return {
    type: 'Atrule',
...
function $l(e) {
  this.token(F, '@' + e.name),
    ...
    e.block ? this.node(e.block) : this.token(K, ';');
}
...
function Yi(e) {
  ...
  return e !== null && (e = e.toLowerCase()),
    ...
    this.skipSC(),
    this.eof !== !0 && this.tokenType !== H && this.tokenType !== K &&
...
function Fl() {
  ...
  const e = this.tokenStart;
  let t = !1;
  return this.isDelim(Xi) ? (t = !0, this.next()) : this.isDelim(kn) || this.eat(b),
    this.isDelim(kn)
      ? this.charCodeAt(this.tokenStart + 1) !== yt
        ? (this.next(), this.eat(b))
...
function Dl() {
  ...
  return t !== yt && // =
    ...
    this.next(),
    t !== yt &&
    (this.isDelim(yt) || this.error('Equal sign is expected'), this.next()),
    this.substrToCursor(e);
}
const Rl = 'AttributeSelector',
  Bl = {
    name: 'Identifier',
    matcher: [String, null],
...
function Ji() {
  ...
  return this.eat(te),
    ...
    this.tokenType !== ue &&
    (this.tokenType !== b &&
      (n = Dl.call(this), this.skipSC(), r = this.tokenType === he ? this.String() : this.Identifier(), this.skipSC()),
      this.tokenType === b && (i = this.consume(b), this.skipSC())),
    this.eat(ue),
    {
...
function Hl(e) {
  this.token(A, '['),
    ...
    e.flags !== null && this.token(b, e.flags),
    this.token(A, ']');
}
...
function so() {
  ...
  let t = this.tokenEnd;
  return this.eat(q),
    t - e + 2 >= 2 && this.charCodeAt(t - 2) === xc &&
    this.charCodeAt(t - 1) === vc && (t -= 2),
    {
      type: 'Comment',
      loc: this.getLocation(e, this.tokenStart),
...
function Rc() {
  ...
  return t.type !== 'Raw' && this.eof === !1 && this.tokenType !== K &&
    this.isDelim(lo) === !1 && this.isBalanceEdge(e) === !1 && this.error(),
    t;
}
const Bc = 'Declaration',
  Hc = 'declaration',
  Vc = {
...
function co() {
  const e = this.tokenStart,
    ...
    n = Wc.call(this),
    r = Dn(n),
    i = r ? this.parseCustomProperty : this.parseValue,
    o = r ? Dc : Fc;
  let s = !1, l;
  ...
  if (
    r || this.skipSC(),
      i ? l = this.parseWithFallback(Rc, o) : l = o.call(this, this.tokenIndex),
      r && l.type === 'Value' && l.children.isEmpty
  ) {
    for (let a = c - this.tokenIndex; a <= 0; a++) {
      if (this.lookupType(a) === N) {
  ...
  return this.isDelim(lo) && (s = Uc.call(this), this.skipSC()),
    this.eof === !1 && this.tokenType !== K && this.isBalanceEdge(t) === !1 &&
    this.error(),
    {
      type: 'Declaration',
      loc: this.getLocation(e, this.tokenStart),
...
function qc(e) {
  this.token(b, e.property),
    this.token(G, ':'),
    this.node(e.value),
    e.important &&
    (this.token(A, '!'), this.token(b, e.important === !0 ? 'important' : e.important));
}
function Wc() {
  const e = this.tokenStart;
  if (this.tokenType === A) {
...
function uo() {
  ...
  for (; !this.eof;) {
    switch (this.tokenType) {
      ...
      default:
        this.isDelim(Kc)
          ? e.push(this.parseWithFallback(this.Rule, nn))
          : e.push(this.parseWithFallback(this.Declaration, nn));
    }
  }
  return {
...
function po(e) {
  ...
  let n, r = null;
  if (
    this.eat($), this.skipSC(), n = this.consume(b), this.skipSC(), this.tokenType !== x
  ) {
...
function su(e) {
  this.token($, '('),
    this.token(b, e.name),
    e.value !== null && (this.token(G, ':'), this.node(e.value)),
    this.token(x, ')');
}
...
function mo(e = 'unknown') {
  const t = this.tokenStart,
    ...
    r = uu.call(this, e, n.toLowerCase());
  this.skipSC();
...
function hu(e) {
  this.token(S, e.feature + '('), this.node(e.value), this.token(x, ')');
}
...
function fo(e = 'unknown') {
  ...
  const n = rn.call(this),
    r = Kr.call(this, n.type === 'Identifier'),
    i = rn.call(this);
  let o = null, s = null;
  return this.lookupNonWSType(0) !== x &&
    (o = Kr.call(this), s = rn.call(this)),
    this.skipSC(),
    this.eat(x),
    {
      type: 'FeatureRange',
...
function vu(e) {
  this.token(S, e.name + '('), this.children(e), this.token(x, ')');
}
...
function bo(e) {
  const t = this.tokenStart;
  let n = null;
  this.tokenType === S ? n = this.consumeFunctionName() : this.eat($);
...
function Tu(e) {
  e.function ? this.token(S, e.function + '(') : this.token($, '('), this.children(e), this.token(x, ')');
}
const Au = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty(
    {
      __proto__: null,
...
function vo() {
  ...
  for (
    this.skipSC();
    !this.eof && (e.push(this.Layer()), this.lookupTypeNonSC(0) === J);
  ) {
...
function So() {
  ...
  if (this.skipSC(), this.tokenType === b && this.lookupTypeNonSC(1) !== $) {
    ...
    switch (
      o === 'not' || o === 'only' ? (this.skipSC(), t = o, n = this.consume(b)) : n = i, this.lookupTypeNonSC(0)
    ) {
      case b: {
...
function Ju(e) {
  e.mediaType
    ? (e.modifier && this.token(b, e.modifier),
      this.token(b, e.mediaType),
      e.condition && (this.token(b, 'and'), this.node(e.condition)))
...
function Co() {
  ...
  for (
    this.skipSC();
    !this.eof && (e.push(this.MediaQuery()), this.tokenType === J);
  ) {
    this.next();
  }
  return {
...
function To() {
  ...
  const e = this.tokenStart;
  let t = e, n = null, r;
  return this.lookupValue(0, 'odd') || this.lookupValue(0, 'even') ? r = this.Identifier() : r = this.AnPlusB(),
    t = this.tokenStart,
    this.skipSC(),
...
function _h(e) {
  this.token(G, ':'),
    e.children === null ? this.token(b, e.name) : (this.token(S, e.name + '('), this.children(e), this.token(x, ')'));
}
...
function Vh() {
  return this.tokenIndex > 0 && this.lookupType(-1) === N
    ? this.tokenIndex > 1 ? this.getTokenStart(this.tokenIndex - 1) : this.firstCharOffset
    : this.tokenStart;
}
const qh = 'Raw',
  Wh = {
...
function zo(e, t) {
  ...
  return this.skipUntilBalanced(
    this.tokenIndex,
    e || this.consumeUntilBalanceEnd,
  ),
    t && this.tokenStart > n ? r = Vh.call(this) : r = this.tokenStart,
    {
      type: 'Raw',
...
function Kh() {
  ...
  return e.type !== 'Raw' && this.eof === !1 && this.tokenType !== H &&
    this.error(),
    e;
}
const Qh = 'Rule',
...
function No() {
  ...
  return this.tokenType === $ &&
    (this.next(),
      this.skipSC(),
      e = this.parseWithFallback(
        this.SelectorList,
        () => this.Raw(!1, !0),
      ),
      this.skipSC(),
      this.eat(x)),
    this.lookupNonWSType(0) === b &&
    (this.skipSC(),
      this.eatIdent('to'),
      this.skipSC(),
      this.eat($),
...
function np(e) {
  e.root && (this.token($, '('), this.node(e.root), this.token(x, ')')),
    e.limit &&
    (this.token(b, 'to'), this.token($, '('), this.node(e.limit), this.token(x, ')'));
}
...
function jo() {
  ...
  return this.getFirstListNode(e) === null &&
...
function Fo() {
  const e = this.createList();
  for (; !this.eof;) {
    if (e.push(this.Selector()), this.tokenType === J) {
      this.next();
      continue;
    }
    break;
...
function Ro(e) {
  const t = e.length,
    n = e.charCodeAt(0),
    r = n === Do || n === dp ? 1 : 0,
    i = r === 1 && t > 1 && e.charCodeAt(t - 1) === n ? t - 2 : t - 1;
  let o = '';
  for (let s = r; s <= i; s++) {
    ...
    if (l === wn) {
      ...
      if (l = e.charCodeAt(++s), fe(wn, l)) {
        const c = s - 1, a = Ne(e, c);
        s = a - 1, o += fi(e.substring(c + 1, a));
      } else {
        l === 13 && e.charCodeAt(s + 1) === 10 && s++;
      }
    } else {
      o += e[s];
    }
...
const $p = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty(
  ...
  Zr = 124;
function on() {
  this.tokenType !== b && this.isDelim(Op) === !1 &&
  this.error('Identifier or asterisk is expected'), this.next();
}
const Lp = 'TypeSelector',
  Pp = {
    name: String,
  };
function qo() {
  const e = this.tokenStart;
  return this.isDelim(Zr)
    ? (this.next(), on.call(this))
    : (on.call(this), this.isDelim(Zr) && (this.next(), on.call(this))),
    {
      type: 'TypeSelector',
      loc: this.getLocation(e, this.tokenStart),
      name: this.substrToCursor(e),
...
function zp(e) {
  this.charCodeAt(this.tokenStart) !== e &&
    this.error((e === Wo ? 'Plus sign' : 'Hyphen minus') + ' is expected');
}
function Mp() {
  let e = 0;
  switch (this.tokenType) {
  ...
  for (let o = n; o <= r; o++) {
    ...
    if (s === vn) {
      ...
      if (s = e.charCodeAt(++o), fe(vn, s)) {
        const l = o - 1, c = Ne(e, l);
        o = c - 1, i += fi(e.substring(l + 1, c));
      } else {
...
function Wp(e) {
  ...
  for (let r = 0; r < e.length; r++) {
    ...
    i === Rp || i === vn || i === Bp || i === Hp || i === Vp || i === Ko
      ? (t += '\\' + e.charAt(r), n = !1)
      : (n && ve(i) && (t += ' '), t += e.charAt(r), n = !1);
  }
  return 'url(' + t + ')';
}
const Up = 'Url',
...
function Zo(e) {
  switch (this.tokenType) {
    ...
    case U:
      return this.Url();
    case b:
      return this.cmpChar(this.tokenStart, ud) &&
          this.cmpChar(this.tokenStart + 1, ei)
        ? this.UnicodeRange()
        : this.Identifier();
    case A: {
...
const hd = {
  ...
  kd = 126;
function wd(e, t) {
  t.last !== null && t.last.type !== 'Combinator' && e !== null &&
    e.type !== 'Combinator' && t.push({
...
function xd() {
  switch (this.tokenType) {
    ...
    case M:
      return this.Percentage();
    case T:
      this.charCodeAt(this.tokenStart) === ti &&
...
function Cd() {
  const e = this.createList();
  if (
    this.skipSC(), e.push(this.Identifier()), this.skipSC(), this.tokenType === J
  ) {
...
const Ed = {
  ...
  Ad = /* @__PURE__ */ new Set(['none', 'and', 'not', 'or']),
  $d = {
    parse: {
      prelude() {
        const e = this.createList();
      ...
      prelude() {
        ...
        return this.skipSC(),
          this.tokenType === b &&
            ...
            : this.tokenType === S &&
              this.cmpStr(this.tokenStart, this.tokenEnd, 'layer(') &&
              e.push(this.Function(null, ri)),
          this.skipSC(),
          this.tokenType === S &&
          this.cmpStr(this.tokenStart, this.tokenEnd, 'supports(') &&
          e.push(this.Function(null, ri)),
          (this.lookupNonWSType(0) === b || this.lookupNonWSType(0) === $) &&
...
function em(e) {
  const t = (r) => r.block.children.some((i) => ii(i) ? t(i) : Ee(i) && i.property === 'view-transition-name'),
    n = (r) => {
  ...
  De(e, {
    ...
    enter(r, i, o) {
      ...
      const s = r.block.children.some((c) => Ee(c) && c.property === 'view-transition-name'),
        l = r.prelude.children.some((c) => Xd(c) ? c.children.some((a) => Yn(a) && Xn.includes(a.name)) : !1);
      if (!s && !l) {
        if (t(r)) {
    ...
    enter(t, n, r) {
      if (Xn.includes(t.name)) {
        ...
        i.name === 'view-transition' && i.children && console.warn(
          `View Transition API polyfill, CSS parse error: ::view-transition should not have parentheses. ${
            t.loc ? `Source: ${t.loc.source}; Line: ${t.loc.start.line}; Column: ${t.loc.start.column}` : ''
          }`,
        );
        const o = ns(t);
        r.replace(n, Ot(o));
...
async function oi() {
  ...
  for (const s of e) {
    if (s.ownerNode instanceof HTMLStyleElement) {
      ...
      const l = s.ownerNode.textContent;
      if (!l) continue;
      t.set(s, l);
    }
  }
...
class kt extends HTMLElement {
  ...
  setupForOldImage(t, n) {
    return this.name = t,
      ...
      this.captureElement = n,
      this.captureElement.oldElement &&
      (this.oldImage = new is(), this.oldImage.setup(this.name, this.captureElement), this.appendChild(this.oldImage)),
      this.oldImage;
  }
  setupForNewImage(t, n) {
    return this.name = t,
      this.setAttribute('name', t),
      this.captureElement = n,
      this.captureElement.newElement &&
      (this.newImage = new En(), this.newImage.setup(this.name, this.captureElement), this.appendChild(this.newImage)),
      this.newImage;
  }
  addNewImage() {
    return this.captureElement.newElement &&
      (this.newImage = new En(), this.newImage.setup(this.name, this.captureElement), this.appendChild(this.newImage)),
      this.newImage;
  }
}
const Lt = class Lt {
  constructor() {
    this.element = document.createElement('div'),
      ...
      this.styleEl.textContent = Lt.stylesheet,
...
class rs extends HTMLElement {
  ...
  connectedCallback() {
    this.innerElement.querySelectorAll('[data-vt-scroll-top]').forEach((n) => {
      ...
      this.innerElement.querySelectorAll('[data-vt-scroll-left]').forEach(
        (n) => {
          if (n instanceof HTMLElement) {
            n.style.overflow = 'hidden', n.style.maxHeight = '100vh', n.style.maxWidth = '100vw';
            const r = parseInt(n.getAttribute('data-vt-scroll-top') || '0') ??
              0;
            n.scrollTop = r;
          }
        },
    ...
    this.offsetHeight !== this.innerElement.offsetHeight &&
      t instanceof HTMLElement && !(this.element instanceof HTMLHtmlElement) &&
      (t.style.marginBlockStart = '0');
  }
  getScaleFactor(t, n, r, i, o) {
    let s = '', l = 1, c = 1;
    if (this.element instanceof HTMLHtmlElement) {
      return l = 1, c = 1, s = '', [l, c, s];
    }
    const a = n / i, u = r / o;
    switch (t) {
      case 'fill':
    ...
    return l = Number.isNaN(l) ? 1 : l,
      c = Number.isNaN(c) ? 1 : c,
  ...
  getObjectPositionValues(t, n, r, i, o) {
    ...
    const [s, l] = t.split(' '),
      c = this.captureElement.old.width,
      a = this.captureElement.old.height,
      u = this.captureElement.new.width,
      p = this.captureElement.new.height;
    let d, g;
    if (s.includes('%')) {
      const L = parseFloat(s) / 100;
      d = ((c - n) * L).toString().concat('px'), g = ((u - r) * L).toString().concat('px');
    } else {
      d = s, g = s;
    }
    let w, z;
    if (l.includes('%')) {
      ...
      w = ((a - i) * L).toString().concat('px'), z = ((p - o) * L).toString().concat('px');
    } else {
      w = l, z = l;
    }
    return {
...
class is extends rs {
  ...
  getAnimateImageFunctions() {
    const t = getComputedStyle(this),
      n = t.objectFit,
      [r, i, o] = this.getScaleFactor(n),
      s = t.objectPosition,
      l = this.getObjectPositionValues(
        s,
        r,
        i,
      ),
      c = `translate(${l.old.left}, ${l.old.top})`,
      a = `translate(${l.new.left}, ${l.new.top})`;
    return [
      c,
      a,
      o,
  ...
  getScaleFactor(t) {
    const n = this.captureElement.old.width,
      r = this.captureElement.old.height,
      i = this.captureElement.new.width,
      o = this.captureElement.new.height;
  ...
  getObjectPositionValues(t, n, r) {
    const i = this.innerElement.offsetWidth,
      o = this.innerElement.offsetHeight,
      s = Math.floor(i * n),
      l = Math.floor(o * r);
...
class En extends rs {
  ...
  getScaleFactor(t) {
    const n = this.captureElement.new.width,
      r = this.captureElement.new.height,
      i = this.captureElement.old.width,
      o = this.captureElement.old.height;
    return super.getScaleFactor(
      t,
      n,
      i,
...
class Tn extends HTMLElement {
  constructor() {
    super(),
      this.transitionName = '',
      this.captureElement = new Dt(),
      this.imagePair = new kt(),
      this.groupStyle = document.createElement('style');
  }
  setupForOldImage(t, n) {
    this.transitionName = t,
      ...
      this.captureElement = n,
      this.imagePair = new kt(),
      this.oldImage = this.imagePair.setupForOldImage(t, n);
  ...
  setupForNewImage(t, n) {
    this.transitionName = t,
      ...
      this.captureElement = n,
      this.imagePair = new kt(),
      this.newImage = this.imagePair.setupForNewImage(t, n);
  ...
  mapStyleValuesForAttribute(t) {
    ...
    ((r) => {
      r.width = 'width',
        ...
        r.writingMode = 'writing-mode',
        r.direction = 'direction',
        r.textOrientation = 'text-orientation',
        r.mixBlendMode = 'mix-blend-mode',
        r.backdropFilter = 'backdrop-filter',
        r.colorScheme = 'color-scheme';
    })(n || (n = {}));
    for (const [r, i] of Object.entries(t)) {
      const o = n[r];
  ...
  getSizingAnimationDuration(t) {
    const n = t.animationName.split(', '),
      r = t.animationDuration.split(', '),
      o = new Map(
        n.map((l) => [
          l,
          r[n.indexOf(l)],
  ...
  getSizingAnimationEasing(t) {
    const n = t.animationName.split(', '),
      r = t.animationTimingFunction.split(', ');
    return new Map(
      n.map((s) => [
        s,
        r[n.indexOf(s)],
...
class si {
  constructor() {
    this.width = 0,
      this.height = 0,
      this.styleTransform = 'initial',
      this.transform = 'initial',
      this.writingMode = 'initial',
      this.direction = 'initial',
      this.textOrientation = 'initial',
      this.mixBlendMode = 'initial',
      this.backdropFilter = 'initial',
      this.colorScheme = 'initial';
  }
}
class Dt {
  constructor() {
    this.old = new si(),
      this.groupKeyframes = '',
      this.groupAnimationNameRule = '',
      this.groupStylesRule = '',
      this.imagePairIsolationRule = '',
      this.imageAnimationNameRule = '',
      this.name = '',
      this.new = new si();
  }
}
...
const Je = class Je {
  constructor() {
    this.phase = 'pending-capture',
      this.transitionPromises = new Zn(this),
      this.viewTransitionElement = new An(),
      this.parsedStyleElement = document.createElement('style'),
      this.namedElements = /* @__PURE__ */ new Map(),
      this.oldElements = /* @__PURE__ */ new Map(),
      this.newElements = /* @__PURE__ */ new Map(),
      this.callback = () => {
      },
  ...
  async startViewTransition(t, n) {
    var o;
    if (
      this.phase = 'pending-capture', this.transitionPromises = t, n && (this.callback = n), Je.isViewTransitionActive()
    ) {
      this.skipTransition(
    ...
    try {
      ...
      const l = s instanceof Error
        ? `View Transitions API polyfill: could not parse stylesheets: ${s.name} ${s.message}`
        : s;
      throw this.skipTransition(l), l;
    }
    ...
    this.captureElements('old'),
      ...
      this.activeElement = document.activeElement instanceof HTMLElement ? document.activeElement : void 0,
    ...
    try {
      const s = await oi();
      this.parsedStyleElement = document.createElement('style'),
        this.parsedStyleElement.textContent = s,
        this.viewTransitionElement.appendChild(this.parsedStyleElement);
    } catch (s) {
      const l = s instanceof Error
        ? `View Transitions API polyfill: could not parse stylesheets: ${s.name} ${s.message}`
    ...
    this.captureElements('new'),
      this.setupGroups(),
      this.newElements.forEach((s) => er(s, !1)),
  ...
  skipTransition(t) {
    this.phase === 'pending-capture' && queueMicrotask(async () => {
      ...
      this.phase = 'done',
      this.transitionPromises.ready.reject(t),
      this.transitionPromises.finished.resolve(),
      document.querySelectorAll('view-transition').forEach((r) => r.remove());
  }
  captureElements(t) {
    ...
    for (const [r, i] of n) {
      ...
      try {
        ...
        const g = d instanceof Error ? `Could not clone element ${i}: ${d.message}` : d;
        this.skipTransition(g);
        return;
      }
      o[t].width = i.offsetWidth, o[t].height = i.offsetHeight, o[t].styleTransform = s.transform;
      const l = o[t].styleTransform === 'none' ? '' : o[t].styleTransform,
        c = cn(
          'translate',
          s.translate,
        ),
      ...
      try {
        const d = pm(i), g = `translate(${d.left}px, ${d.top}px)`;
        o[t].transform = `${g} ${p} ${l}`.trim();
      } catch (d) {
        const g = d instanceof Error ? `Could not get position of element ${i}: ${d.message}` : d;
        this.skipTransition(g);
        return;
      }
      o[t].writingMode = s.writingMode,
        o[t].direction = s.direction,
        o[t].textOrientation = s.textOrientation,
        o[t].mixBlendMode = s.mixBlendMode,
        o[t].backdropFilter = s.backdropFilter,
        o[t].colorScheme = s.colorScheme,
        t === 'old' && this.namedElements.set(r, o);
    }
  }
  addUAStylesheet() {
    const t = document.createElement('style');
    t.setAttribute('data-vt-polyfill-style', ''),
      t.textContent = Je.UAStylesheetText,
      this.viewTransitionElement.appendChild(t);
  }
  getNamedTransitionElements() {
    const t = [],
      ...
      r = (i) => {
        ...
        if (
          !(i.checkVisibility() ?? o.getPropertyValue('display') !== 'none')
        ) return;
        const l = i.style.viewTransitionName ||
            o.getPropertyValue('--vt-polyfill-name'),
          c = (a) =>
            a.querySelectorAll(':scope > *').forEach((u) => {
              cm(u) && r(u);
            });
        if (l === 'none') {
          return c(i);
  ...
  setupGroups() {
    for (const t of this.namedElements) {
      const n = t[0], r = t[1];
      let i = r.group;
      i ? i.addNewImage() : (i = new Tn(),
        r.group = i,
        i.setupForNewImage(
          n,
          r,
        ),
        this.viewTransitionElement.appendChild(i)),
        i.setup(),
        i.animateImages();
    }
  }
  ...
  animationsFinished() {
    Promise.allSettled(this.animationPromises).then((t) => {
      t.length === this.animationPromises.length
        ? (this.animationPromises = [],
          this.phase = 'done',
          this.transitionPromises.finished.resolve(),
          li(!0),
          document.body.removeAttribute('inert'),
          this.activeElement && document.body.contains(this.activeElement) &&
...
const ai = (e) =>
  ...
  im = (e) => {
    ...
    return t.top > window.innerHeight + document.documentElement.scrollTop ||
      t.left > window.innerWidth + document.documentElement.scrollLeft;
  },
  om = (e) => {
    const t = getComputedStyle(e).position;
    if (!(t === 'static' || t === 'relative')) return;
    const n = document.createElement('div');
    n.dataset.vtSpacer = '';
    const r = e.getBoundingClientRect();
    return n.style.width = `${r.width}px`, n.style.height = `${r.height}px`, n;
  },
  sm = [
    'color',
    'background-color',
...
function um(e, t = !1) {
  const n = document.createElement('div');
  n.setAttribute('data-vt-default-style-div', ''),
    n.style.all = 'initial',
  ...
  const r = getComputedStyle(n),
    i = (s) => {
      ...
      } else if (s instanceof HTMLVideoElement) {
        try {
          const y = new ui();
          y.setup(s, t), l = y;
        } catch {
      ...
      const c = getComputedStyle(s), a = [];
      if (a.push('all: initial;'), c) {
        for (const y of [...c]) {
          if (lm.includes(y)) continue;
          const C = c.getPropertyValue(y);
          C === r.getPropertyValue(y) && !am.includes(y) ||
            (y === '-webkit-text-fill-color' && a.push(`color: ${C}`), a.push(`${y}: ${C};`));
        }
      }
      if (s instanceof HTMLAnchorElement) {
        for (const y of sm) {
          l.style.setProperty(y, c.getPropertyValue(y));
        }
      }
      const u = 'VT' + Math.random().toString(36).slice(2);
      if (l.setAttribute('id', u), s instanceof HTMLHtmlElement) {
        const y = document.createElement('style');
        y.textContent = `:where(#${u}) {background-color: Canvas}`, l.appendChild(y);
      }
      if (o && (l.style.margin = '0'), rm(l)) {
        l.setAttribute('style', a.join(''));
      } else {
        const y = document.createElement('style');
        y.textContent = `#${u} {${a.join('')}}`, l.appendChild(y);
      }
      l.style.opacity = s.hasAttribute('data-vt-polyfill-opacity')
        ? s.getAttribute('data-vt-polyfill-opacity') || '1'
        : c
        ? c.getPropertyValue('opacity')
        : '1',
        l.removeAttribute('data-vt-polyfill-opacity'),
        o &&
        (l.style.position = 'relative',
          l.style.inset = '0',
          l.style.transform = 'none',
          l.style.translate !== void 0 &&
          (l.style.translate = 'none', l.style.rotate = 'none', l.style.scale = 'none'));
      const p = getComputedStyle(s, '::before');
      if (p.content !== 'none' && p.content !== '-moz-alt-content') {
        const y = document.createElement('style'), C = [];
        for (const D of [...p]) {
          C.push(
            `${D}: ${p.getPropertyValue(D)};`,
          );
        }
        y.textContent = `#${u}::before {${C.join('')}}`, l.appendChild(y);
      }
      const d = getComputedStyle(s, '::after');
      if (d.content !== 'none' && d.content !== '-moz-alt-content') {
        const y = document.createElement('style'), C = [];
        for (const D of [...d]) {
          C.push(
            `${D}: ${d.getPropertyValue(D)};`,
          );
        }
        y.textContent = `#${u}::after {${C.join('')}}`, l.appendChild(y);
      }
      const g = s.scrollTop;
      g !== 0 && l.setAttribute('data-vt-scroll-top', g.toString());
      const w = s.scrollLeft;
      w !== 0 && l.setAttribute('data-vt-scroll-left', w.toString());
      const z = s.childNodes;
      for (const y of [...z]) {
        if (y instanceof Element && !ai(y)) {
          if (o = !1, y.hasAttribute('data-vt-default-style-div')) continue;
          const C = getComputedStyle(y).getPropertyValue('--vt-polyfill-name');
          if (im(y) || C) {
            const E = om(y);
            if (!E) continue;
            l.appendChild(E);
          ...
          y instanceof Text && ((L = y.textContent) != null && L.trim())
        ) {
          const C = y.cloneNode();
          l.append(C);
        }
...
function pm(e) {
  const t = (o) => {
      const s = o.offsetTop, l = o.offsetLeft, c = o.offsetParent;
      let a = { top: 0, left: 0 };
      return c && (a = t(c)), {
        top: s + a.top,
        left: l + a.left,
...
function er(e, t) {
  ...
  } else {t === !0 && e.hasAttribute('data-vt-polyfill-opacity') &&
      (e.style.opacity = e.getAttribute('data-vt-polyfill-opacity') ?? '',
        e.removeAttribute('data-vt-polyfill-opacity'));}
}
function li(e) {
...
function gm(e, t) {
  ...
  if (t === '') {
    return De(n, {
      visit: 'Declaration',
      enter(s, l, c) {
        s.property === '--vt-polyfill-name' && c.remove(l);
      },
    }),
      Ye(n);
  }
  if (r.length >= 2) {
    ...
    De(n, {
      visit: 'Declaration',
      enter(s, l, c) {
        s.property === '--vt-polyfill-name' && s !== o && c.remove(l);
      },
    });
  }
  if (r.length === 1) {
    const o = r[r.length - 1],
      s = Ae(t, { context: 'value' }),
      l = Sn(
        s,
        (u) => Yd(u),
      );
    if (!l || !ci(l)) return e;
    const c = Ot(l);
    return o.value.children.clear(), o.value.children.append(c), Ye(n);
  } else {
    const o = `--vt-polyfill-name: ${t}`,
      s = Ae(o, {
        context: 'declaration',
        parseCustomProperty: !0,
      }),
...
function xm() {
  ...
  Object.defineProperty(HTMLElement.prototype, 'style', {
    get() {
      var r;
      const t = (r = e == null ? void 0 : e.get) == null ? void 0 : r.call(this),
        n = this;
      return Object.defineProperty(t, 'viewTransitionName', {
        ...
        set(i) {
          const o = n.getAttribute('style') || '', s = gm(o, i);
...
document.startViewTransition || (ym(), km(), wm(), xm());
