...
function Rs(e) {
  ...
  const s = br(n), l = br(r), c = function(a, u) {
    function p(y, C, D) {
      const E = d.call(L, y, C, D);
      return E === i ? !0 : E === o ? !1 : !!(w.hasOwnProperty(y.type) && w[y.type](y, L, p, z) || g.call(L, y, C, D) === i);
    }
    ...
    if (typeof u == "function")
      d = u;
    else if (u && (d = mr(u.enter), g = mr(u.leave), u.reverse && (w = r), u.visit)) {
  ...
  return c.break = i, c.skip = o, c.find = function(a, u) {
    let p = null;
...
function Ws(e, t) {
  ...
  return r === n.length || c > 1 ? (u = at(o || t, "end") || qe(yr, a), p = qe(u)) : (u = at(o, "start") || qe(at(t, "start") || yr, a.slice(0, s)), p = at(o, "end") || qe(u, a.substr(s, l))), {
    css: a,
    mismatchOffset: s,
    mismatchLength: l,
    start: u,
...
const He = function(e, t) {
  ...
  return i.rawMessage = e, i.syntax = t ? Fn(t) : "<generic>", i.css = o, i.mismatchOffset = s, i.mismatchLength = l, i.message = e + `
  syntax: ` + i.syntax + `
...
function Ir(e) {
  return e === null ? !0 : e.type === J || e.type === S || e.type === $ || e.type === te || e.type === H || ol(e);
}
function zr(e) {
...
function sl(e, t, n) {
  function r() {
    do
      C++, y = C < e.length ? e[C] : null;
    while (y !== null && (y.type === N || y.type === q));
  }
  function i(Z) {
    const se = C + Z;
  ...
  let p = null, d = null, g = null, w = null, z = 0, L = null, y = null, C = -1, D = 0, E = {
    type: el,
    syntax: null,
    token: null,
    prev: null
  ...
  for (r(); L === null && ++z < _r; )
    switch (t.type) {
      case "Match":
        if (d === null) {
          if (y !== null && (C !== e.length - 1 || y.value !== "\\0" && y.value !== "\\9")) {
            t = P;
            break;
          }
          L = Pr;
      ...
      case "Mismatch":
        ...
        t = g.nextState, d = g.thenStack, p = g.syntaxStack, E = g.matchStack, C = g.tokenIndex, y = C < e.length ? e[C] : null, g = g.prev;
        break;
      case "MatchGraph":
        t = t.match;
        break;
      ...
      case "Property": {
        ...
        if (w !== !1 && y !== null && t.type === "Type" && // https://drafts.csswg.org/css-values-4/#custom-idents
...
class Fr {
  ...
  validate() {
    ...
    function n(c, a, u, p) {
      if (u.has(a))
        return u.get(a);
      u.set(a, !1), p.syntax !== null && Ga(p.syntax, function(d) {
        if (d.type !== "Type" && d.type !== "Property")
          return;
        const g = d.type === "Type" ? c.types : c.properties, w = d.type === "Type" ? i : o;
        hasOwnProperty.call(g, d.name) ? n(c, d.name, w, g[d.name]) && (r.push(`${t(a, u === i)} used broken syntax definition ${t(d.name, d.type === "Type")}`), u.set(a, !0)) : (r.push(`${t(a, u === i)} used missed syntax definition ${t(d.name, d.type === "Type")}`), u.set(a, !0));
      }, this);
    }
    const r = [];
    ...
    const s = [...i.keys()].filter((c) => i.get(c)), l = [...o.keys()].filter((c) => o.get(c));
...
function Qi(e = !1) {
  ...
  switch (this.eat(F), n = this.substrToCursor(t + 1), r = n.toLowerCase(), this.skipSC(), this.eof === !1 && this.tokenType !== H && this.tokenType !== K && (this.parseAtrulePrelude ? i = this.parseWithFallback(this.AtrulePrelude.bind(this, n, e), Rr) : i = Rr.call(this, this.tokenIndex), this.skipSC()), this.tokenType) {
    case K:
      this.next();
      break;
    case H:
...
function $l(e) {
  this.token(F, "@" + e.name), e.prelude !== null && this.node(e.prelude), e.block ? this.node(e.block) : this.token(K, ";");
}
...
function co() {
  ...
  if (r || this.skipSC(), i ? l = this.parseWithFallback(Rc, o) : l = o.call(this, this.tokenIndex), r && l.type === "Value" && l.children.isEmpty) {
...
function vo() {
  const e = this.createList();
  for (this.skipSC(); !this.eof && (e.push(this.Layer()), this.lookupTypeNonSC(0) === J); )
...
function Co() {
  const e = this.createList();
  for (this.skipSC(); !this.eof && (e.push(this.MediaQuery()), this.tokenType === J); )
    this.next();
  return {
    type: "MediaQueryList",
    loc: this.getLocationFromList(e),
...
function Po() {
  const e = this.tokenStart;
  let t = null, n, r;
  return this.eat(G), this.tokenType === S ? (n = this.consumeFunctionName(), r = n.toLowerCase(), this.lookupNonWSType(0) == x ? t = this.createList() : hasOwnProperty.call(this.pseudo, r) ? (this.skipSC(), t = this.pseudo[r].call(this), this.skipSC()) : (t = this.createList(), t.push(
    this.Raw(null, !1)
...
function _h(e) {
  this.token(G, ":"), e.children === null ? this.token(b, e.name) : (this.token(S, e.name + "("), this.children(e), this.token(x, ")"));
}
...
function _o() {
  const e = this.tokenStart;
  let t = null, n, r;
  return this.eat(G), this.eat(G), this.tokenType === S ? (n = this.consumeFunctionName(), r = n.toLowerCase(), this.lookupNonWSType(0) == x ? t = this.createList() : hasOwnProperty.call(this.pseudo, r) ? (this.skipSC(), t = this.pseudo[r].call(this), this.skipSC()) : (t = this.createList(), t.push(
    this.Raw(null, !1)
  )), this.eat(x)) : n = this.consume(b), {
...
function jh(e) {
  this.token(G, ":"), this.token(G, ":"), e.children === null ? this.token(b, e.name) : (this.token(S, e.name + "("), this.children(e), this.token(x, ")"));
}
...
function Vh() {
  return this.tokenIndex > 0 && this.lookupType(-1) === N ? this.tokenIndex > 1 ? this.getTokenStart(this.tokenIndex - 1) : this.firstCharOffset : this.tokenStart;
}
const qh = "Raw", Wh = {
  value: String
};
...
function mp(e, t) {
  ...
  for (let s = 0; s < e.length; s++) {
    ...
    l === r || l === wn ? (i += "\\" + e.charAt(s), o = !1) : (o && (ve(l) || $e(l)) && (i += " "), i += e.charAt(s), o = !1);
  }
  return n + i + n;
}
const fp = "String", gp = {
...
function Qo() {
  ...
  switch (this.tokenType) {
    case U:
      ...
      break;
    case S:
      this.cmpStr(this.tokenStart, this.tokenEnd, "url(") || this.error("Function name must be `url`"), this.eat(S), this.skipSC(), t = Ro(this.consume(he)), this.skipSC(), this.eof || this.eat(x);
      break;
    default:
...
function Cd() {
  const e = this.createList();
  if (this.skipSC(), e.push(this.Identifier()), this.skipSC(), this.tokenType === J) {
  ...
  De(e, {
    ...
    enter(r, i, o) {
      if (this.atrule && !Jd.includes(this.atrule.name))
        return;
      const s = r.block.children.some((c) => Ee(c) && c.property === "view-transition-name"), l = r.prelude.children.some((c) => Xd(c) ? c.children.some((a) => Yn(a) && Xn.includes(a.name)) : !1);
      if (!s && !l) {
        if (t(r)) {
...
class rs extends HTMLElement {
  ...
  getScaleFactor(t, n, r, i, o) {
    ...
    return l = Number.isNaN(l) ? 1 : l, c = Number.isNaN(c) ? 1 : c, l = parseFloat(l.toFixed(2)), c = parseFloat(c.toFixed(2)), s = `scale(${l}, ${c})`, [l, c, s];
  }
  getObjectPositionValues(t, n, r, i, o) {
    ...
    const [s, l] = t.split(" "), c = this.captureElement.old.width, a = this.captureElement.old.height, u = this.captureElement.new.width, p = this.captureElement.new.height;
    let d, g;
    if (s.includes("%")) {
...
class is extends rs {
  ...
  getAnimateImageFunctions() {
    const t = getComputedStyle(this), n = t.objectFit, [r, i, o] = this.getScaleFactor(n), s = t.objectPosition, l = this.getObjectPositionValues(
      s,
      r,
      i
    ), c = `translate(${l.old.left}, ${l.old.top})`, a = `translate(${l.new.left}, ${l.new.top})`;
    return [
      c,
      a,
      o
  ...
  getObjectPositionValues(t, n, r) {
    const i = this.innerElement.offsetWidth, o = this.innerElement.offsetHeight, s = Math.floor(i * n), l = Math.floor(o * r);
...
class Tn extends HTMLElement {
  ...
  setupForOldImage(t, n) {
    this.transitionName = t, this.setAttribute("name", t), this.captureElement = n, this.imagePair = new kt(), this.oldImage = this.imagePair.setupForOldImage(t, n);
...
const Je = class Je {
  ...
  async startViewTransition(t, n) {
    ...
    try {
      ...
      const l = s instanceof Error ? `View Transitions API polyfill: could not parse stylesheets: ${s.name} ${s.message}` : s;
      throw this.skipTransition(l), l;
    }
    this.addUAStylesheet(), this.viewTransitionElement.appendChild(this.parsedStyleElement), this.namedElements = /* @__PURE__ */ new Map();
    try {
    ...
    this.captureElements("new"), this.setupGroups(), this.newElements.forEach((s) => er(s, !1)), this.transitionPromises.ready.resolve(), this.phase = "animating";
  ...
  captureElements(t) {
    ...
    for (const [r, i] of n) {
      ...
      const l = o[t].styleTransform === "none" ? "" : o[t].styleTransform, c = cn(
        "translate",
        s.translate
      ), a = cn(
        "rotate",
  ...
  getNamedTransitionElements() {
    const t = [], n = /* @__PURE__ */ new Map(), r = (i) => {
      ...
      if (!(i.checkVisibility() ?? o.getPropertyValue("display") !== "none")) return;
      const l = i.style.viewTransitionName || o.getPropertyValue("--vt-polyfill-name"), c = (a) => a.querySelectorAll(":scope > *").forEach((u) => {
        cm(u) && r(u);
      });
      if (l === "none")
        return c(i);
      ...
      return l !== "" && (t.push(l), n.set(l, i), (i === document.documentElement || i === document.body) && this.viewTransitionElement.classList.add("has-root-group")), c(i);
    };
    try {
...
const ai = (e) => [
  ...
  "view-transition-old",
  "view-transition-new"
].includes(e.tagName.toLowerCase()), rm = (e) => [
  "area",
  "base",
  "br",
  "col",
...
function um(e, t = !1) {
  const n = document.createElement("div");
  n.setAttribute("data-vt-default-style-div", ""), n.style.all = "initial", n.style.display = "none", document.body.appendChild(n);
  const r = getComputedStyle(n), i = (s) => {
    var L;
    if (ai(s))
      return;
    let l;
    ...
    if (a.push("all: initial;"), c)
      for (const y of [...c]) {
        ...
        C === r.getPropertyValue(y) && !am.includes(y) || (y === "-webkit-text-fill-color" && a.push(`color: ${C}`), a.push(`${y}: ${C};`));
      }
    ...
    l.style.opacity = s.hasAttribute("data-vt-polyfill-opacity") ? s.getAttribute("data-vt-polyfill-opacity") || "1" : c ? c.getPropertyValue("opacity") : "1", l.removeAttribute("data-vt-polyfill-opacity"), o && (l.style.position = "relative", l.style.inset = "0", l.style.transform = "none", l.style.translate !== void 0 && (l.style.translate = "none", l.style.rotate = "none", l.style.scale = "none"));
    ...
    for (const y of [...z])
      if (y instanceof Element && !ai(y)) {
        ...
        const D = i(y);
        D && l.appendChild(D);
      } else if (y instanceof Text && ((L = y.textContent) != null && L.trim())) {
        const C = y.cloneNode();
        l.append(C);
      }
    return l;
...
function gm(e, t) {
  ...
  if (r.length === 1) {
    const o = r[r.length - 1], s = Ae(t, { context: "value" }), l = Sn(
      s,
      (u) => Yd(u)
    );
    if (!l || !ci(l)) return e;
